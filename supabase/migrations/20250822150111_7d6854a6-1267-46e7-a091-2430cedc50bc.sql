-- Supprimer et recréer la fonction pour retourner les vraies données non masquées des événements difficiles
DROP FUNCTION IF EXISTS public.get_public_difficult_events();
