-- Créer la fonction en utilisant exactement les noms de colonnes de la base de données
...
BEGIN
  ...
  -- Mettre à jour les informations du membre avec les vrais noms de colonnes de la base
  UPDATE members 
  SET 
