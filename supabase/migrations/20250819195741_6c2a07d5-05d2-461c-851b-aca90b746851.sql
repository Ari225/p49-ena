-- Corriger la fonction create_testimonial_with_verification avec les vrais noms de colonnes
...
BEGIN
  ...
  SELECT id, "Pr�noms", "Nom de famille", "Emploi fonction publique", "Photo"
  ...
  INSERT INTO public.testimonials (
    ...
    v_member_record.id,
    CONCAT(v_member_record."Pr�noms", ' ', v_member_record."Nom de famille"),
