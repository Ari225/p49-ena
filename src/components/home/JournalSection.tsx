      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-12">
          <div className="lg:w-1/3 w-full">
            <div className="bg-gradient-to-br from-primary to-primary/80 p-4 md:p-8 rounded-lg shadow-xl px-0 py-0">
          ...
          <div className="lg:w-2/3 w-full rounded-xl py-6 md:py-12 lg:py-[75px] px-4 md:px-[20px] bg-transparent">
            <h3 className="font-bold mb-4 md:mb-6 text-center bg-primary text-white py-2 md:py-[10px] rounded-lg text-lg md:text-xl">
              Perspectives 49 - Bulletin n°1
            </h3>
            <p className="leading-relaxed mb-4 md:mb-6 text-justify text-secondary-foreground text-sm md:text-base">
