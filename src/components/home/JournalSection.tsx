        ...
        <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-12">
          ...
          <div className="lg:w-2/3 w-full rounded-xl py-6 md:py-12 px-4 md:px-[20px] bg-transparent lg:py-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <Button asChild className="bg-primary text-white hover:bg-primary/90 px-4 py-2 rounded flex items-center text-sm md:text-base transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                <Link to="/derniere-edition" className="bg-primary text-white hover:bg-primary/90 px-4 py-2 rounded flex items-center text-sm md:text-base transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Dernière édition</Link>
              </Button>
