  ...
  return <section className="bg-white py-12 md:py-16 lg:py-[100px] px-4 md:px-8 lg:px-[100px]">
      <div className="container mx-auto px-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 md:mb-12 gap-4">
          ...
          <Button asChild className="bg-primary text-white font-extrabold hover:bg-primary py-[5px] px-[15px] rounded flex items-center text-sm md:text-sm transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {regionalNews.map((news, index) => <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-3 md:p-4">
                ...
                <p className="text-xs text-gray-700">{news.date}</p>
              </CardContent>
            </Card>)}
        </div>
      </div>
