      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="w-full max-w-none px-0">
          ...
          {isMobile ? (
            ...
            // Tablet: 2-column grid with navigation
            <div className="relative">
              <div className="grid grid-cols-2 gap-6 mb-6">
                {news.slice(currentIndex, currentIndex + 2).map((item, index) => {
                  const actualIndex = (currentIndex + index) % news.length;
                  return (
                      ...
                      <Link to={`/actualite/${item.id}`}>
                        <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer bg-white border border-gray-200 h-full">
                          ...
                          <CardContent className="p-6">
                            ...
                            <h3 className="font-bold text-primary text-xl leading-tight line-clamp-2 mb-3">
                              {item.title}
                            </h3>
