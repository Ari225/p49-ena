...
const MobileMenu = () => {
  ...
  return <>
      ...
      <div className={`fixed ${isTab ? 'top-[76px]' : 'top-[70px]'} left-0 right-0 w-screen bg-white shadow-lg border-t border-gray-200 max-h-[calc(100vh-76px)] overflow-y-auto z-40 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0 pointer-events-none'}`}>
