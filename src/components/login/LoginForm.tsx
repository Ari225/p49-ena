...
const LoginForm = () => {
  ...
  if (isMobile) {
    return <div className="py-[50px] px-[25px] bg-background">
  ...
  if (isTablet) {
    return <div className="py-[75px] px-[50px] bg-background">
  ...
  // Desktop version
  return <div className="py-[100px] px-8 md:px-[100px] bg-background">
      <div className="w-full max-w-md mx-auto">
        <Card>
          <CardHeader className="text-center">
