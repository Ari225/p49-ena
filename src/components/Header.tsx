            ...
            {menuItems.map((menu, index) => (
              <DropdownMenu key={index}>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className="text-gray-700 hover:text-primary hover:bg-accent transition-colors duration-200 flex items-center space-x-1"
                  >
                ...
                <DropdownMenuContent className="w-56 bg-white border border-gray-200 shadow-lg">
                  {menu.items.map((item, itemIndex) => (
                    <DropdownMenuItem key={itemIndex} asChild>
                      <Link 
                        to={item.href}
                        className="w-full px-4 py-2 text-gray-700 hover:bg-accent hover:text-primary transition-colors duration-200"
                      >
                        {item.label}
                      </Link>
                    </DropdownMenuItem>
              ...
              <div key={index} className="mb-4">
                ...
                {menu.items.map((item, itemIndex) => (
                  <Link 
                    key={itemIndex}
                    to={item.href}
                    className="block px-8 py-2 text-gray-700 hover:bg-accent hover:text-primary transition-colors duration-200"
