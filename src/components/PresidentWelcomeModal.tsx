...
const PresidentWelcomeModal = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className={`w-full ${isMobile ? 'max-w-[calc(100vw-50px)] mx-[25px] my-[80px]' : 'max-w-[calc(100vw-200px)]'} h-auto bg-white p-0 fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]`}>
