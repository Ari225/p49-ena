    ...
    return (
      <section className="py-16 px-[25px]">
        <div className="container mx-auto px-0">
          <h2 className="text-xl font-bold text-primary mb-[10px] md:mb-[10px] text-center">La P49, une promotion d'excellence</h2>
  ...
  if (isTablet) {
    return (
      <section className="py-20 px-[50px]">
        <div className="container mx-auto px-0">
          <h2 className="text-2xl font-bold text-primary mb-[10px] md:mb-[10px] text-center">La P49, une promotion d'excellence</h2>
    ...
    <section className="py-[100px] px-8 md:px-[100px]">
      <div className="container mx-auto px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-3xl font-bold text-primary mb-[10px] md:mb-[10px] text-left">La P49, une promotion d'excellence</h2>
