...
const BlogFormDialog: React.FC<BlogFormDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className={`${isMobile ? 'w-[95vw] max-w-[95vw] mx-auto rounded-lg max-h-[60vh] overflow-y-auto' : 'w-[85%] max-w-2xl max-h-[35vh] overflow-y-auto rounded-xl mx-auto'}`}>
        <DialogHeader>
