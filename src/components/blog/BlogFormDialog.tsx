...
const BlogFormDialog: React.FC<BlogFormDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className={`${isMobile ? 'w-[95vw] max-w-[95vw] mx-auto rounded-lg max-h-[50vh] overflow-y-auto' : 'w-[85%] max-w-2xl max-h-[25vh] overflow-y-auto rounded-xl mx-auto'}`}>
        <DialogHeader>
