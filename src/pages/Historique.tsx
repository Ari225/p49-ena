...
const Historique = () => {
  ...
  return (
    <Layout>
      <div className="bg-accent/30 py-12 lg:py-[100px] px-4 lg:px-[100px]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 lg:mb-12">
            <h1 className="font-bold text-primary mb-4 text-3xl lg:text-5xl">Historique du Réseau</h1>
            <p className="max-w-3xl mx-auto text-gray-700 text-base lg:text-lg font-normal">
              Historique, création et situation administrative de l'association
            </p>
          </div>

          {/* Hero Section */}
          <div className="bg-white rounded-lg shadow-lg p-6 lg:p-8 mb-8 lg:mb-12 lg:px-[35px] lg:py-[35px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div>
                <h2 className="font-bold text-primary mb-4 lg:mb-6 text-xl lg:text-2xl">La P49 : une promotion d'excellence</h2>
                <p className="text-gray-700 leading-relaxed mb-4 text-justify text-sm lg:text-base">
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl lg:text-3xl font-bold text-center text-primary mb-8 lg:mb-12">Chronologie</h2>
            <div className="relative">
              ...
              {timeline.map((event, index) => (
                <div 
                  key={index} 
                  className={`relative flex items-center mb-8 lg:mb-12 ${index % 2 === 0 ? 'lg:justify-start' : 'lg:justify-end'}`}
                >
                  {/* Timeline Dot */}
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-primary rounded-full border-4 border-white shadow-lg z-10 hidden lg:block"></div>
                  
                  {/* Content Card */}
                  <Card className={`w-full lg:w-5/12 ${index % 2 === 0 ? 'lg:mr-auto' : 'lg:ml-auto'} shadow-lg hover:shadow-xl transition-shadow duration-300`}>
                    <CardContent className="p-4 lg:p-6">
                      <div className="flex items-center mb-3">
                        <div className="bg-primary text-white font-bold text-sm lg:text-lg px-2 lg:px-3 py-1 rounded-ss">
                          {event.year}
                        </div>
                      </div>
                      <h3 className="text-lg lg:text-xl font-bold text-primary mb-3">{event.title}</h3>
                      <p className="text-gray-700 leading-relaxed text-sm lg:text-base">{event.description}</p>
                    </CardContent>
                  </Card>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mt-12 lg:mt-16">
            <Card className="shadow-lg">
              <CardContent className="p-6 lg:p-8">
                <h3 className="text-xl lg:text-2xl font-bold text-primary mb-4 lg:mb-6">Notre Mission</h3>
            ...
            <Card className="shadow-lg">
              <CardContent className="p-6 lg:p-8">
                <h3 className="text-xl lg:text-2xl font-bold text-primary mb-4 lg:mb-6">Notre Vision</h3>
