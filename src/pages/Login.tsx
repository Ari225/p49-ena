...
const Login = () => {
  ...
  return (
    <Layout>
      <div className="min-h-[80vh] flex items-center justify-center py-12 lg:py-[100px] relative px-4 lg:px-0" 
           style={{
          ...
          <Card>
            <CardHeader className="text-center">
              <img 
                ...
                alt="P49 ENA Logo" 
                className="h-12 lg:h-16 w-12 lg:w-16 object-contain mx-auto mb-4" 
              />
              <CardTitle className="font-bold text-primary text-2xl lg:text-3xl">
                {t('login.title')}
              </CardTitle>
            </CardHeader>
            <CardContent>
