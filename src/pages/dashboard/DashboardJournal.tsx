            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {editions.length === 0 ? (
                  ...
                  editions.map((edition) => (
                    <div key={edition.id} className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                      <div className="flex items-center space-x-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {edition.summary && (
                            <p className="text-sm text-gray-600 line-clamp-2">{truncateText(edition.summary, 120)}</p>
                          )}
                        </div>
                      </div>
