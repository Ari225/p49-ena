...
const RenforcementCapacites = () => {
  ...
  return <Layout>
      <div className="min-h-screen bg-gray-50">
        ...
        {isMobile && <div className="container mx-auto py-12 px-[25px]">
            <div className="grid grid-cols-1 gap-6">
              {programs.map((program, index) => <Card key={index} className="hover:shadow-xl transition-shadow duration-300">
                  <CardHeader>
                  ...
                  <CardContent>
                    <ul className="space-y-2 mb-6">
                      {program.features.map((feature, idx) => <li key={idx} className="flex items-center text-sm text-gray-700">
        ...
        {isTab && <div className="container mx-auto py-16 px-[50px]">
        ...
        {!isMobile && !isTab && <div className="container mx-auto py-16 px-[100px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {programs.map((program, index) => <Card key={index} className="hover:shadow-xl transition-shadow duration-300">
                  <CardHeader>
                    <div className="flex items-center mb-4">
