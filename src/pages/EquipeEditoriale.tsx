                ...
                <div>
                  ...
                  {(() => {
                    ...
                    if (isMobile) {
                      ...
                      gridClass = 'grid grid-cols-1 md:grid-cols-2 gap-x-0 gap-y-4 md:gap-y-6 justify-items-center max-w-lg mx-auto';
                    } else if (memberCount === 3) {
                      gridClass = 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-0 gap-y-4 md:gap-y-6 justify-items-center max-w-2xl mx-auto';
                    } else {
                      gridClass = 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-0 gap-y-4 md:gap-y-6 justify-items-center max-w-3xl mx-auto';
                    }
