  ...
  const regions = [
    {
      ...
      actualites: [
        "Inauguration du nouveau siège régional",
        "Séminaire sur la digitalisation administrative",
        "Rencontre avec les autorités préfectorales"
      ]
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=400&h=300&fit=crop",
      actualites: [
        "Projet de développement rural en cours",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=400&h=300&fit=crop",
      actualites: [
        "Lancement du hub d'innovation administrative",
        "Rencontre avec le secteur privé",
        "Programme de mentorat jeunes cadres"
      ]
    },
    {
      name: "Région du Nord",
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="pt-2 border-t">
                      ...
                      <ul className="space-y-1">
                        {region.actualites.map((actualite, idx) => (
