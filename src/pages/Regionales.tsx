      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className={`relative ${isMobile ? 'h-[30vh]' : 'h-[60vh]'} flex items-center justify-center text-white overflow-hidden`}>
          <div className="absolute inset-0">
            <img src="/lovable-uploads/92f8a2dc-a96b-43e9-93dd-b8dec8af0527.png" alt="Background régionales" className="w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4">
            ...
            {selectedTab === 'futures' && <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {regionalesFutures.map(regionale => <RegionaleCard key={regionale.id} regionale={regionale} />)}
                </div>
              </div>}
